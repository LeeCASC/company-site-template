        ...
        <div className="container max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-[80px] pr-4 sm:pr-6 md:pr-8 lg:pr-[73px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div
                key={i}
                className="rounded-card bg-brand-accent-50 p-[13px] flex flex-col overflow-hidden transition-all hover:shadow-lg"
              ...
              >
                ...
                <p className="text-body text-gray-400 leading-[150%] line-clamp-2 min-h-[3rem]">{t('newsCardText')}</p>
              </div>
            ))}
          </div>
        </div>
